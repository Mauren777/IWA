...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('content.xml', function(err, result) {
      ...
      result.content[obj.sec_n].product.push({'title': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
