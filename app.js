...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('content.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('content.xsl', 'utf8'); //We are reading in the XSL file
...
router.get('/get/shop', function(req, res) {

    res.writeHead(200, {'Content-Type': 'text/html'}); //We are responding to the client that the content served back is HTML and the it exists (code 200)

    var xml = fs.readFileSync('content.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('content-shop.xsl', 'utf8'); //We are reading in the XSL file
    var doc = xmlParse(xml); //Parsing our XML file
    var stylesheet = xmlParse(xsl); //Parsing our XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('content.xml', function(err, result) {
      if (err) throw (err);
      //This is where you pass on information from the form inside index.html in a form of JSON and navigate through our JSON (XML) file to create a new  object
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('content.xml', function(err, result) {
        // console.log("response", obj.product);
        // console.log(result.catalogue.section[0].product[obj.product].title);
      if (err) throw (err);
      ...
      delete result.catalogue.section[0].product[obj.product];
